...
public class Plant extends Entity {
    public Plant(Coord arrPos, WorldSimulator wmRef, String name, File imageFile) {
        super(Transform.simpleTransform(arrPos.x*wmRef.getWorldData().getTileSize(), arrPos.y*wmRef.getWorldData().getTileSize(), 0), new Identity(name, "entity"), arrPos, wmRef, imageFile);
    }
